...
const AboutPage = () => {
  return (
    <main className={styles.About}>
      <h1>About KIT</h1>
      <p>KIT is a tool for improving your communication with the people that matter to you. If you&apos;ve got personal or professional connections that you want to nourish with regular contact, re:connect can help.</p>
