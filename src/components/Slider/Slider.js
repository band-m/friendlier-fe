...
export default function Slider() {
  ...
  return (
    <article>
      <div className={styles.contactFrequencyInputs}>How often do you want to be in contact with name?
        <p>Every</p>
        <input type='number' min={1} value={num} onChange={({ target }) => changeNumOfDaysInput(+target.value)} />
